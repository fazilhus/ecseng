...
namespace Core {
    ...
    */
    ...
    /**
    */
    CVar* CVarCreate(CVarType type, const char* name, const char* defaultValue, const char* description) {
        CVarCreateInfo info;
        info.name = name;
    ...
    */
    CVar* CVarGet(const char* name) {
        ...
        if (it != cVarTable.end()) { return &cVars[it->second]; }
    ...
    */
    ...
    /**
    */
    int CVarNum() { return cVarOffset; }

    //------------------------------------------------------------------------------
    /**
    */
    CVar* CVarsBegin() { return cVars; }

    //------------------------------------------------------------------------------
    /**
    */
    CVar* CVarsEnd() { return cVars + cVarOffset; }

    //------------------------------------------------------------------------------
    /**
    */
    CVar* CVarNext(CVar* cVar) { return cVar + 1; }
} // namespace Core
