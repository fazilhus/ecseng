...
namespace Render {
    struct ParticleEmitter {
        ...
        struct EmitterBlock {
            ...
            uint32_t fireOnce = 1;
            // set to true if you want to fire this particle system once. This will reset all particles to their initial states.
            uint32_t emitterType = 0;
            // 0 is spherical, 1 is from a circular disc with "dir" as normal and theta as spread.
